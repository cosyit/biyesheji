(function($){
    ...
    $.extend($.tzPageRenderers.defaultRenderer.prototype, {
        ...
        getLinks:function(current_page, eventHandler,psize) {
            ...
            if(this.opts.showGo)fragment.append("<a href='javascript:void(0);'  style='float:left;'>共<label class='tmui_page_itemcount'>"+this.maxentries+"</label>条</a>&nbsp;<a href='javascript:void(0);' title='请输入其他页码' style='' class='tm_go'>前往</a><input type='text' title='请输入其他页码' class='tm_number' value='"+proxySzie+"' id='tm_pagego'/><span class='tm_go' style='color:#FFF;'>页</span>");
            return fragment;
